...
<head>
  ...
  <script src='swagger/lang/translator.js' type='text/javascript'>
</script><script src='swagger/lang/zh-cn.js' type='text/javascript'></script>
    ...
    $(function () {
      ...
      if (url && url.length > 1) {
       ...
       url = getWebRoot()+"/api-docs"; // 设置自适应的url  
        	//url = "http://localhost:8080/web-hr-src/api-docs";
      }
